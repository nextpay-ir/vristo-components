...
const thStyles = cva(
    "px-3 py-2 text-left rtl:text-right text-xs font-bold text-gray-700 uppercase tracking-wider"
);
...
interface DataGridProps<T> {
    ...
    onPaginationModelChange?: (newModel: Updater<PaginationState>) => void;
    className?: string;
}
            ...
            {paginationModel && (
                <div className="flex justify-between items-center py-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <Icon icon="weui:arrow-outlined" className="rtl:rotate-180" width={15} height={15}/>
                        </button>
                    </div>
                </div>
            )}
